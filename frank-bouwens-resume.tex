...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  ...
  Ik heb verstand van web-technologie\"en als:\ \acr{HTML+CSS}, \acr{XML}, \acr{REST}, \acr{JSON}, \acr{SOAP} and JavaScript. Linux vaardigheden: bash, Apache en My\acr{SQL}.}
